 ...
 */
public class Hotel5EstrellasService extends Hotel4EstrellasService {
    ...
    public Hotel5Estrellas crearHotel5Estrellas() {
        ...
        hotel5.setCantPisos(hotel4.getCantPisos());
        hotel5.setGimnasio(hotel4.isGimnasio());
    ...
    public double calcularPrecioHabitacion5Estrellas(Hotel5Estrellas hotel5){
        double precio = super.calcularPrecioHabitacion(hotel5);
        precio+= 15*hotel5.getCantLimosinas();
        return precio;
    }
