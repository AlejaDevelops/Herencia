...
import E7SistemaDeConsultaDeAlojamientosService.SistemaConsultaAlojamientosService;

/**
 *
 * @author AlejaDevelops
 */
public class ConsultaDeAlojamientosMain {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        SistemaConsultaAlojamientosService scs = new SistemaConsultaAlojamientosService();
        scs.menu();
